...
def main(args):
    ...
    if not args.predict:
        ...
        train_dataloader = data.DataLoader(train_dataset, batch_size=args.batch_size, num_workers=12, pin_memory=True,
                                           shuffle=True, drop_last=True)
        val_dataset = ThousandLandmarksDataset(os.path.join(args.data, 'train'), test_transforms, split="val")
        val_dataloader = data.DataLoader(val_dataset, batch_size=args.batch_size, num_workers=12, pin_memory=True,
    ...
    test_dataloader = data.DataLoader(test_dataset, batch_size=args.batch_size, num_workers=12, pin_memory=True,
                                      shuffle=False, drop_last=False)
